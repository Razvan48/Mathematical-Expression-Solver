...
train_losses_per_epoch, val_losses_per_epoch, train_accuracies_per_epoch, val_accuracies_per_epoch, val_predictions, val_labels = train_model(model, train_dataloader, val_dataloader, num_epochs=5, learning_rate=0.001)
